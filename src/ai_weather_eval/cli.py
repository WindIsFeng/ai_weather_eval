...
def _build_catalog(args: argparse.Namespace) -> int:
    ...
    manifest = {
        ...
        "ibtracs": {
            ...
            "source_url": ibtracs_config.get("source_url"),
            "source_last_modified_utc": ibtracs_config.get("source_last_modified_utc"),
            "source_etag": ibtracs_config.get("source_etag"),
            "source_content_length_bytes": ibtracs_config.get("source_content_length_bytes"),
            "source_byte_range": ibtracs_config.get("source_byte_range"),
            "quality": ibtracs_quality_summary(tracks_all),
        },
        "coastline": {
            "path": str(coastline_path),
            "version": coastline_config["version"],
            "source_url": coastline_config.get("source_url"),
            "resolution": coastline_config["resolution"],
            "level": coastline_config["level"],
            "archive_bytes": coastline_config.get("archive_bytes"),
